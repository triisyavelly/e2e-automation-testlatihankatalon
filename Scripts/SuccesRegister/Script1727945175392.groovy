...
WebUI.setText(findTestObject('Object Repository/Register/input_email_email'), '031024test@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Register/input_password_password'), 'nLdpTDgNe94tzXBSEM/iaA==')
